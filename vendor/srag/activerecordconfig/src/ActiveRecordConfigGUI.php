...
namespace srag\ActiveRecordConfig\OnlyOffice;

use ilPluginConfigGUI;
use ilUtil;
use srag\ActiveRecordConfig\OnlyOffice\Exception\ActiveRecordConfigException;
use srag\DIC\OnlyOffice\DICTrait;

/**
 * Class ActiveRecordConfigGUI
 *
 * @package    srag\ActiveRecordConfig\OnlyOffice
 *
